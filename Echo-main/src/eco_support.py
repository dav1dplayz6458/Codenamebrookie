...
cosmetics_items = {
    # Swords
    "Grim Reapers sword": {"name": "Rare Sword", "sell": 2500, "chance": 25},
    ...
    "Pages": {"name": "Anicent Pages that were written a long time ago ", "sell": 10, "chance": 20},

    # Other items (High to low chance)
    "First edition Bible": {"name": "An item that only the gods can hold.", "sell": 15000000, "chance": 20},
    "infinity Glove": {"name": "Infinity Gauntlet", "sell": 30000, "chance": 5},
    "Brookie's Laptop": {"name": "The Developer's laptop and its also a rarest item in the game", "sell": 250000, "chance": 1},
    "stick": {"name": "Wack people with it", "sell": 15000, "chance": 15},
    "gun": {"name": "A RUSSIAN AK-47", "sell": 8000, "chance": 19},
    "tech": {"name": "Iphone 15 Collecters edition", "sell": 1000, "chance": 25},
    "weed": {"name": "a blunt just in case you wanna chill", "sell": 5000, "chance": 30},
    "Car": {"name": " Voom Voom baby", "sell": 500, "chance": 40},
    "charcoal": {"name": "Charcoal from the finest mines were is", "sell": 300, "chance": 50},
    "clock": {"name": "WAKE UP, YOU GOT WORK TO DO", "sell": 700, "chance": 30},
    "roll": {"name": "Roll the dice and get nothing", "sell": 1500, "chance": 33},
    "potato": {"name": "A potato from Technoblade", "sell": 100, "chance": 65},
    "Infinity Stones": {"name": "The Stones that soloed half of the avengers ", "sell": 1000, "chance": 65}
}


# List of all items you can craft
craftables = {
    "White powder": {"name": "a suspicious powder", "sell": 10000},
    "poo": {"name": "its brown ", "sell": 2000},
    "c4": {"name": "We are blowing up the soviet union bor with this", "sell": 25000},
    "excalibur": {"name": "The Excalibur", "sell": 35000},
    "m4a1": {"name": "Brookie's favorite gun in call of duty", "sell": 30000},
    "excalibur": {"name": "Excalibur", "sell": 30000},
    "Bible": {"name": "Did you pray today?", "sell": 40000},
    "complete_gauntlet": {"name": "The most Powerful item in the game ", "sell": 6000000},
    "glitch": {"name": "Woah you found a glitch in the bot", "sell": 50000000}
}
...
shop_items = {
    ...
    "shovel": {"desc": "hit people in the head", "cost": 1000},
    "bow": {"desc": "You can now hunt animals! Sell what you find and make money while doing it.", "cost": 1000},
    "Pages": {"name": "Anicent Pages that were written a long time ago ", "sell": 10},
...
crafting_recipes = {
    ...
    "Bible": {
        "stick": 1,
        "pages": 1500,
        "result": "Bible"  # Did you pray today?
    },
    "complete_gauntlet": {
        "infinity glove": 1,
        "infinity stones": 6,
    ...
    "white powder": {
        "roll": 1,
        "weed": 1,
        "result": "white powder" # Get high asf 
    },
    "glitch": {
        "god": 2,
...
def update_bank_balance(user_id, amount): # type: ignore
